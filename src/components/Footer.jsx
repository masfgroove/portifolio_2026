    ...
    <footer className="border-t border-slate-800 px-6 py-8">
      <div className="mx-auto flex max-w-7xl flex-col gap-4 text-sm text-slate-500 md:flex-row md:items-center md:justify-between">
        ...
        <div className="flex gap-4 items-center">
          ...
          <a href="mailto:Masfgroove2012@gmail.com" className="hover:text-cyan-400" title="E-mail"><Mail size={19} /></a>
          <a href="https://wa.me/5511987052920" target="_blank" className="hover:text-cyan-400" title="WhatsApp"><Phone size={19} /></a>
        </div>
      </div>
    </footer>
  )
